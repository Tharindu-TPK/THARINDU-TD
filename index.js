...
async function connectToWA() {
  ...
  console.log("Connecting ❤️THARINDU❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️THARINDU❤️ installed successful ✅");
      console.log("❤️THARINDU❤️ connected to whatsapp ✅");

      let up = `❤️THARINDU❤️ connected successful ✅`;
      let up1 = `THARINDU BRO, I made bot successful`;
      ...
      robin.sendMessage("94787791638@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Tharindu-TPK/BOT-Helpar/refs/heads/main/Screenshot_20260108_155612.jpg`,
        },
        caption: up1,
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    robin.sendFileUrl = async (jid, url, caption, quoted, options = {}) => {
     ...
     //Owner react
     if (senderNumber.inclludes("94787791638")) {
      if (isReact) return;
       m.react("🙈");
     }
    //work type
...
app.get("/", (req, res) => {
  res.send("hey, ❤️THARINDU❤️ started✅");
});
app.listen(port, () =>
